...
| **F1** ⛔ G3 | 11 migraciones y seeders, auth completa, roles y políticas, catálogos con sus reglas, CRUD de obras con geometría manual, fechas, código, concurrencia optimista, papelera lógica, auditoría, componentes de aplicación | 001, 007, 010, 014, 015, 018 | **002, 003, 004, 008, 009, 025** |
...
| **F6** | Papelera completa, borrado definitivo por tipeo exacto, UI de auditoría con diff, configuración tipada, usuarios y sesiones | — | **014, 016, 017, 018, 024** |
