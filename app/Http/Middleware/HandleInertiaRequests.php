...
class HandleInertiaRequests extends Middleware
{
    ...
    public function share(Request $request): array
    {
        ...
        return [
            ...
            // El tema efectivo lo estampa el layout antes de la primera pintura;
            // esto es para que el cliente sepa qué eligió el usuario.
            'theme' => $user === null ? 'system' : $user->theme_preference,
